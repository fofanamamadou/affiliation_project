...
# Configuration PostgreSQL si les variables d'environnement sont définies
try:
...
AFFILIATION_BASE_URL = "http://localhost:8000"
...
# Configuration pour envoyer des mail (optionnel)
try:
    from decouple import config
